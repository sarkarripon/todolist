                    ...
                    <div class="col-lg">
                        <form action="signup_php.php" method="POST">
                            ...
                            <div class="form-floating">
                                <input type="text"
                                       value="<?php echo isset($_SESSION['fnameValue']) ? $_SESSION['fnameValue'] : ""; ?>"
                                       class="form-control" id="fname" name="fname" placeholder="John">
                            ...
                            <div class="form-floating">
                                <input type="text"
                                       value="<?php echo isset($_SESSION['lnameValue']) ? $_SESSION['lnameValue'] : ""; ?>"
                                       class="form-control" id="lname" name="lname" placeholder="Doe">
                            ...
                            <div class="form-floating">
                                <input type="email"
                                       value="<?php echo isset($_SESSION['emailValue']) ? $_SESSION['emailValue'] : ""; ?>"
                                       class="form-control" id="email" name="email" placeholder="name@example.com">
                            ...
                            <div class="form-floating">
                                <input type="password" class="form-control" id="password" name="re_password"
